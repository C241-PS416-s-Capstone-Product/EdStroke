...
class RiskViewModel(
    ...
    private val _riskResult = MutableLiveData<PredictResponse>()
    val riskResult: LiveData<PredictResponse> = _riskResult
    ...
    fun riskScreeningResult(riskRequest: RiskScreeningRequest) {
        _isLoading.postValue(true)

        viewModelScope.launch {
            try {
                //get success message
                val result = riskRepository.riskScreening(riskRequest)
